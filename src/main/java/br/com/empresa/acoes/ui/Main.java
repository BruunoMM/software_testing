...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		for (Acao acao : acoes) {
			...
			System.out.println();
			System.out.printf("Fechamento Minimo: %s $%s", dataFechamentoMinimo, valorFechamentoMinimo);
			System.out.println();
			System.out.printf("Fechamento Maximo: %s $%s", dataFechamentoMaximo, valorFechamentoMaximo);
			System.out.println();
			...
			System.out.printf("Volume Medio: %.2f", acao.getVolumeMedio());
			System.out.println();
