...
public class AcaoTest extends TestCase {
	...
	private Acao acaoSFX0;
	private Acao acaoBRX7;
	private Acao acaoFLX8;
	...
	public void runBefore() {
		...
		// Acao sem fechamentos
		acaoSFX0 = new Acao("SFX0");
		
		// Acao com 1 fechamento com volume == 0
		acaoBRX7 = new Acao("BRX7");
		acaoBRX7.addFechamento(new FechamentoAcao(acaoBRX7, data1, valorFechamento1, volume4));
		
		// Acao com 1 fechamento com volume != 0
		acaoFLX8 = new Acao("FLX8");
		acaoFLX8.addFechamento(new FechamentoAcao(acaoFLX8, data2, valorFechamento2, volume2));
	...
	public void testAcaoVolumeMedio() {
		double retornoVolumeMedioSF = acaoSFX0.getVolumeMedio();
		double retornoVolumeMedioBR = acaoBRX7.getVolumeMedio();
		double retornoVolumeMedioFL = acaoFLX8.getVolumeMedio();
		
		assertEquals("Valor volume medio SFX0 deve ser 0", 0.0, retornoVolumeMedioSF);
		assertEquals("Valor volume medio BRX7 deve ser 0", 0.0, retornoVolumeMedioBR);
		assertEquals("Valor volume medio FLX8 deve ser ", new Double(562343), retornoVolumeMedioFL);
